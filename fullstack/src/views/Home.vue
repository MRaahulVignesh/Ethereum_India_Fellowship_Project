...
<template >
  ...
  <b-container>
   <b-card class="mx-auto" bg-variant="dark" header="Features of the platform" header-tag="h4" text-variant="light" header-border-variant="light" style="max-width: 35rem;">
    <b-card-text>
      > Subscriptions based on ERC-721 Token
    </b-card-text>
